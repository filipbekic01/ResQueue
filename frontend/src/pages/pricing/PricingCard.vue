...
<template>
  <div
    class="border basis-1/3 bg-white border-gray-200 rounded-xl p-8 text-center relative"
    :class="[
      {
        'border-gray-400 border scale-105': recommended,
        'border-gray-200': !recommended
      }
    ]"
  >
    <Tag
